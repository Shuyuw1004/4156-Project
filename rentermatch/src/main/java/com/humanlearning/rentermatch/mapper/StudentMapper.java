...
public interface StudentMapper {
  ...
  int saveStudent(@Param("email") String email, @Param("name") String name,
      @Param("sClientId") String sClientId, @Param("uni") String uni);
  ...
  int updateStudent(@Param("sClientId") String sClientId, @Param("email") String email,
      @Param("name") String name, @Param("uni") String uni);
