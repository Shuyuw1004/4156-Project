...
public class TenantController {
  ...
  public ResponseEntity<String> getMatch(String tClientId) {
    ...
    List<Tenant> matchedTenants = tenantMapper.getMatch(tClientId, age, cooking,
        tearlyTimeSleep,
    ...
    //send email
    return new ResponseEntity<>(tenants.toString(), responseHeaders, HttpStatus.OK);
  }
}
